...
Use the `prd-solution-review` skill workflow. In this repository, the source lives at:
- `skills/prd-solution-review/SKILL.md`
- `skills/prd-solution-review/references/review-template.md`
